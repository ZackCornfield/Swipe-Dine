...
const SearchForm = () => {
    ...
    const handleSuggestSelect = (suggest) => {
        if (suggest) {
            const { locatioon } = suggest; // Taking location from the suggest object
                ...
                >
                    <div className={styles.searchSection}>
                        ...
                        <div className={styles.searchLocationSection}>
                            ...
                            {mapsLoaded ? (
                                <Geosuggest
                                    ...
                                    onSuggestSelect={
                                        (suggest) =>
                                            handleSuggestSelect(suggest) // Handle the selected suggestion
                                    }
                                />
                            ) : (
                        ...
                        <div className={styles.typeSection}>
                            <label for="types">Whats the crave?</label>
